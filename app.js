...
let generateResultTimeStatus = (status) => {
  if(status == "ej start") {
    ...
    return finishedSVG + '<small class="pl-1">' + status + '</small>'
  }
}
